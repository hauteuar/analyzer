#!/usr/bin/env python3
"""
DB2 MCP Server - A Model Context Protocol server for DB2 database operations.
This server provides tools to query DB2 databases, list tables, and get schemas.
"""
...
class DB2MCPServer:
    ...
    def connect_db2(self) -> bool:
        ...
        try:
            ...
            # Connect to DB2
            conn = ibm_db.connect(self.conn_string, "", "")
        ...
        try:
            ...
            if not self.connection:
                if not self.connect_db2():
                    return [TextContent(
                        type="text",
                        text="Failed to connect to DB2. Check environment variables."
                    )]
